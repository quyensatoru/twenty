...
import { buildMerchantStandardFlatFieldMetadatas } from 'src/engine/workspace-manager/twenty-standard-application/utils/field-metadata/compute-merchant-standard-flat-field-metadata.util';
...
import { buildProjectStandardFlatFieldMetadatas } from 'src/engine/workspace-manager/twenty-standard-application/utils/field-metadata/compute-project-standard-flat-field-metadata.util';
import { buildSprintStandardFlatFieldMetadatas } from 'src/engine/workspace-manager/twenty-standard-application/utils/field-metadata/compute-sprint-standard-flat-field-metadata.util';
...
const STANDARD_FLAT_FIELD_METADATA_BUILDERS_BY_OBJECT_NAME = {
  app: buildAppStandardFlatFieldMetadatas,
  appAccess: buildAppAccessStandardFlatFieldMetadatas,
  ...
  sprint: buildSprintStandardFlatFieldMetadatas,
  epic: buildEpicStandardFlatFieldMetadatas,
