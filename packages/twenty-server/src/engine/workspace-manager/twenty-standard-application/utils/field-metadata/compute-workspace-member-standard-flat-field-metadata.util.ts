...
> => ({
  ...
  ledProjects: createStandardRelationFieldFlatMetadata({
    ...
    context: {
      ...
      label: i18nLabel(
        msg({ message: `Led projects`, context: 'fieldMetadata.label' }),
      ),
      description: i18nLabel(
        msg({
          message: `Projects led by the workspace member`,
          context: 'fieldMetadata.description',
        }),
      ),
  ...
  appAccesses: createStandardRelationFieldFlatMetadata({
    ...
    context: {
      ...
      description: i18nLabel(
        msg({
          message: `App access grants for the workspace member`,
          context: 'fieldMetadata.description',
        }),
      ),
      icon: 'IconLock',
  ...
  assignedIssues: createStandardRelationFieldFlatMetadata({
    ...
    context: {
      ...
      label: i18nLabel(
        msg({ message: `Assigned issues`, context: 'fieldMetadata.label' }),
      ),
      description: i18nLabel(
        msg({
          message: `Issues assigned to the workspace member`,
          context: 'fieldMetadata.description',
        }),
      ),
  ...
  reportedIssues: createStandardRelationFieldFlatMetadata({
    ...
    context: {
      ...
      label: i18nLabel(
        msg({ message: `Reported issues`, context: 'fieldMetadata.label' }),
      ),
      description: i18nLabel(
        msg({
          message: `Issues reported by the workspace member`,
          context: 'fieldMetadata.description',
        }),
      ),
      icon: 'IconLayoutKanban',
  ...
  assignedEpics: createStandardRelationFieldFlatMetadata({
    ...
    context: {
      ...
      label: i18nLabel(
        msg({ message: `Assigned epics`, context: 'fieldMetadata.label' }),
      ),
      description: i18nLabel(
        msg({
          message: `Epics assigned to the workspace member`,
          context: 'fieldMetadata.description',
        }),
      ),
      icon: 'IconStack2',
  ...
  ownedSprints: createStandardRelationFieldFlatMetadata({
    ...
    context: {
      ...
      label: i18nLabel(
        msg({ message: `Owned sprints`, context: 'fieldMetadata.label' }),
      ),
      description: i18nLabel(
        msg({
          message: `Sprints owned by the workspace member`,
          context: 'fieldMetadata.description',
        }),
      ),
      icon: 'IconRun',
  ...
  issueComments: createStandardRelationFieldFlatMetadata({
    ...
    context: {
      ...
      label: i18nLabel(
        msg({ message: `Issue comments`, context: 'fieldMetadata.label' }),
      ),
      description: i18nLabel(
        msg({
          message: `Issue comments authored by the workspace member`,
          context: 'fieldMetadata.description',
        }),
      ),
      icon: 'IconMessage',
  ...
  worklogs: createStandardRelationFieldFlatMetadata({
    ...
    context: {
      ...
      description: i18nLabel(
        msg({
          message: `Worklogs logged by the workspace member`,
          context: 'fieldMetadata.description',
        }),
      ),
      icon: 'IconClock',
  ...
  shifts: createStandardRelationFieldFlatMetadata({
    ...
    context: {
      ...
      description: i18nLabel(
        msg({
          message: `Shifts worked by the workspace member`,
          context: 'fieldMetadata.description',
        }),
      ),
      icon: 'IconCalendarClock',
