...
>): Record<AllStandardObjectFieldName<'issue'>, FlatFieldMetadata> => ({
  ...
  issueType: createStandardFieldFlatMetadata({
    ...
    context: {
      ...
      options: [
        {
          id: 'f0adaafa-e069-4b6e-8042-439cbf792792',
          value: 'EPIC',
  ...
  status: createStandardFieldFlatMetadata({
    ...
    context: {
      ...
      options: [
        {
          id: '23ab95da-bd98-4183-8d69-e063f58367fd',
          value: 'BACKLOG',
          label: i18nLabel(msg`Backlog`),
          position: 0,
          color: 'gray',
        },
        {
          id: '804e21d5-dbb2-47cb-bcaf-c1838e0edcb6',
          value: 'TODO',
          label: i18nLabel(msg`Todo`),
          position: 1,
          color: 'sky',
        },
        {
          id: 'd4a4895d-1c46-4400-a86c-30330f04714a',
          value: 'IN_PROGRESS',
        ...
        {
          id: '04eb3a16-d4fe-4429-afca-237f374c3ee0',
          value: 'IN_REVIEW',
        ...
        {
          id: '024877e8-d7ab-411e-86d8-d30e92231b9f',
          value: 'DONE',
