...
>): Record<AllStandardObjectFieldName<'worklog'>, FlatFieldMetadata> => ({
  ...
  position: createStandardFieldFlatMetadata({
    ...
    context: {
      ...
      description: i18nLabel(msg`Worklog record position`),
      icon: 'IconHierarchy2',
      isSystem: true,
      isNullable: false,
      defaultValue: 0,
  ...
  description: createStandardFieldFlatMetadata({
    ...
    context: {
      ...
      description: i18nLabel(msg`Worklog description`),
      icon: 'IconNotes',
      isNullable: true,
    },
    standardObjectMetadataRelatedEntityIds,
  ...
  timeSpentMinutes: createStandardFieldFlatMetadata({
    ...
    context: {
      ...
      description: i18nLabel(msg`Time logged in minutes`),
      icon: 'IconClock',
      isNullable: true,
    },
    standardObjectMetadataRelatedEntityIds,
  ...
  startedAt: createStandardFieldFlatMetadata({
    ...
    context: {
      ...
      description: i18nLabel(msg`When the logged work started`),
  ...
  issue: createStandardRelationFieldFlatMetadata({
    ...
    context: {
      ...
      description: i18nLabel(msg`Logged issue`),
  ...
  member: createStandardRelationFieldFlatMetadata({
    ...
    context: {
      ...
      description: i18nLabel(msg`Workspace member who logged the time`),
      icon: 'IconUserCircle',
      isNullable: true,
