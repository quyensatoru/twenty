...
export const buildIssueCommentStandardFlatFieldMetadatas = ({
  now,
  objectName,
  workspaceId,
  ...
  CreateStandardFieldArgs<'issueComment', FieldMetadataType>,
  'context'
>): Record<AllStandardObjectFieldName<'issueComment'>, FlatFieldMetadata> => ({
  ...
  parentComment: createStandardRelationFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      type: FieldMetadataType.RELATION,
  ...
  attachments: createStandardRelationFieldFlatMetadata({
    ...
    context: {
      ...
      targetFieldName: 'targetIssueComment',
      settings: {
        relationType: RelationType.ONE_TO_MANY,
      },
    },
