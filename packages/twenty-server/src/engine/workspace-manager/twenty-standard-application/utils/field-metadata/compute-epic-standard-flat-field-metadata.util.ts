...
> => ({
  ...
  name: createStandardFieldFlatMetadata({
    ...
    context: {
      ...
      description: i18nLabel(
        msg({ message: `Epic name`, context: 'fieldMetadata.description' }),
      ),
      icon: 'IconStack2',
      isNullable: true,
    },
  ...
  assignee: createStandardRelationFieldFlatMetadata({
    ...
    context: {
      ...
      description: i18nLabel(
        msg({ message: `Epic assignee`, context: 'fieldMetadata.description' }),
      ),
      icon: 'IconUserCircle',
      isNullable: true,
  ...
  issues: createStandardRelationFieldFlatMetadata({
    ...
    context: {
      ...
      description: i18nLabel(
        msg({ message: `Epic's issues`, context: 'fieldMetadata.description' }),
      ),
  ...
  timelineActivities: createStandardRelationFieldFlatMetadata({
    ...
    context: {
      ...
      description: i18nLabel(
        msg({
          message: `Timeline Activities linked to the epic`,
          context: 'fieldMetadata.description',
        }),
      ),
