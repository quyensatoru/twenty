...
export const buildIssueCommentStandardFlatIndexMetadatas = ({
  now,
  objectName,
  workspaceId,
...
}: Omit<CreateStandardIndexArgs<'issueComment'>, 'context'>): Record<
  AllStandardObjectIndexName<'issueComment'>,
  FlatIndexMetadata
> => ({
