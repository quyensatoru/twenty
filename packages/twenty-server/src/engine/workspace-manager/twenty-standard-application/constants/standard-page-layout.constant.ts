import {
  ...
  STANDARD_EPIC_PAGE_LAYOUT_CONFIG,
  ...
  STANDARD_MERCHANT_PAGE_LAYOUT_CONFIG,
  STANDARD_MESSAGE_PARTICIPANT_PAGE_LAYOUT_CONFIG,
  STANDARD_MESSAGE_LIST_PAGE_LAYOUT_CONFIG,
  STANDARD_ISSUE_COMMENT_PAGE_LAYOUT_CONFIG,
  STANDARD_ISSUE_PAGE_LAYOUT_CONFIG,
  ...
  STANDARD_PROJECT_PAGE_LAYOUT_CONFIG,
  STANDARD_SHIFT_PAGE_LAYOUT_CONFIG,
  STANDARD_SHIFT_TEMPLATE_PAGE_LAYOUT_CONFIG,
  STANDARD_SPECIAL_DAY_PAGE_LAYOUT_CONFIG,
  STANDARD_SPRINT_PAGE_LAYOUT_CONFIG,
  ...
  STANDARD_WORKLOG_PAGE_LAYOUT_CONFIG,
...
export const STANDARD_PAGE_LAYOUTS = {
  ...
  issueRecordPage: STANDARD_ISSUE_PAGE_LAYOUT_CONFIG,
  issueCommentRecordPage: STANDARD_ISSUE_COMMENT_PAGE_LAYOUT_CONFIG,
  worklogRecordPage: STANDARD_WORKLOG_PAGE_LAYOUT_CONFIG,
  shiftTemplateRecordPage: STANDARD_SHIFT_TEMPLATE_PAGE_LAYOUT_CONFIG,
  specialDayRecordPage: STANDARD_SPECIAL_DAY_PAGE_LAYOUT_CONFIG,
  shiftRecordPage: STANDARD_SHIFT_PAGE_LAYOUT_CONFIG,
  ...
  projectRecordPage: STANDARD_PROJECT_PAGE_LAYOUT_CONFIG,
  sprintRecordPage: STANDARD_SPRINT_PAGE_LAYOUT_CONFIG,
  epicRecordPage: STANDARD_EPIC_PAGE_LAYOUT_CONFIG,
  merchantRecordPage: STANDARD_MERCHANT_PAGE_LAYOUT_CONFIG,
